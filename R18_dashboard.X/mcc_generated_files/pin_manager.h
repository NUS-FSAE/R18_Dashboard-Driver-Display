...
#define SD_CS_LAT                LATDbits.LATD2
#define SD_CS_PORT               PORTDbits.RD2
#define SD_CS_ANS                ANCON1bits.ANSEL13
#define SD_CS_SetHigh()            do { LATDbits.LATD2 = 1; } while(0)
#define SD_CS_SetLow()             do { LATDbits.LATD2 = 0; } while(0)
#define SD_CS_Toggle()             do { LATDbits.LATD2 = ~LATDbits.LATD2; } while(0)
#define SD_CS_GetValue()           PORTDbits.RD2
#define SD_CS_SetDigitalInput()    do { TRISDbits.TRISD2 = 1; } while(0)
#define SD_CS_SetDigitalOutput()   do { TRISDbits.TRISD2 = 0; } while(0)
#define SD_CS_SetAnalogMode()  do { ANCON1bits.ANSEL13 = 1; } while(0)
#define SD_CS_SetDigitalMode() do { ANCON1bits.ANSEL13 = 0; } while(0)
